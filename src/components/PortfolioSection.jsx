    ...
    <div className="max-w-4xl mx-auto py-12 " id="post-1">
      ...
      <div className="flex flex-wrap justify-center pt-2 ">
        ...
        <div className="flex flex-col  p-6 m-6 overflow-hidden bg-white shadow-2xl rounded-2xl sm:w-60 hover:bg-sky-100">
          <img src={"" } alt="" />
          <p className="mt-3 sm:text-2xl font-semibold text-center">CountiesApp</p>
        ...
        <div className="flex flex-col p-6 m-6 overflow-hidden bg-white shadow-2xl rounded-2xl sm:w-60 hover:bg-sky-100">
          <img src={""} alt="" />
          <p className="mt-3 sm:text-2xl font-semibold text-center">MemeGenerator</p>
        ...
        <div className="flex flex-col  p-6 m-6 overflow-hidden bg-white shadow-2xl rounded-2xl sm:w-60 hover:bg-sky-100 ">
          <img src={""} alt="" />
          <p className="mt-1 sm:mt-3 sm:text-2xl font-semibold text-center"> GifApp</p>
        ...
        <div className="flex flex-col  p-6 m-6 overflow-hidden bg-white shadow-2xl rounded-2xl sm:w-60 hover:bg-sky-100">
          ...
          <p className="mt-3 sm:text-2xl font-semibold text-center">MoviesApp</p>
          <div className="flex justify-center gap-2 m-2">
