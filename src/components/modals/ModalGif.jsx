                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6 flex-auto">
                                    <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                        Este pagina web en el que el usuario puede buscar cualquier
                                        gif con tan solo ingresar un texto en un campo, el proyecto
                                        se realizó en React, estilado con TailwindCss, para un diseño responsivo. Este se encarga de hacer 
                                        peticiones al Api de Giphy Developers para obtener los gifs solicitados
