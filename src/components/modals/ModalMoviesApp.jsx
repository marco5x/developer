							...
							<div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
								...
								<div className="relative p-6 flex-auto">
									<p className="my-4 text-slate-500 text-lg leading-relaxed">
										Esta es una Pagina web ( SPA ) creada con React js, Redux
										con un diseño con teconologia CSS3 y diseño responsivo.
										Permite buscar peliculas, agregarlas a favoritas y eliminarlas,
										y haciendo click sobre el poster 🖱. se obtiene el detalle de la misma
									</p>
								</div>
								{/*footer*/}
