...
function Type() {
  return (
    <Typewriter
      options={{
        strings: ["Muchas gracias por su visita!!"],
        autoStart: true,
        loop: true,
        deleteSpeed: 50,
      }}
...
export const FooterSection = () => {
  return (
    <div className="py-5 border-t-3/2 dark:text-white ">
      <ScrollToTop
        data-aos="fade-up"
      ...
      <div className=" flex justify-center mt-4">
        <p className="text-black text-center mb-4">
          <span className="mr-1 dark:text-white " role="img" aria-label="heart">
            Hecho con 💙 en Argentina (Jujuy) by{" "}
          </span>
          <a
